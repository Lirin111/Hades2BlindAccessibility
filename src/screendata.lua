function mod.setupScreenData()
    ModUtil.Table.Merge(ScreenData, {
        BlindTalentScreen = {
            Name = "BlindTalentScreen",
            DefaultStartX = 25,
            DefaultStartY = 250,
            DefaultTalentXSpacer = 300,
            DefaultTalentYSpacer = 90,
            ...
            GamepadNavigation =
            {
                ...
                FreeFormSelectStepDistance = 100,
                FreeFormSelectSuccessDistanceStep = 100,
            },
            ...
            ComponentData =
            {
                ...
                Background =
                {
                    ...
                    Children =
                    {
                        ...
                        SpellBacking =
                        {
                            Graphic = "ButtonTalent",
                            GroupName = "Combat_Menu_Overlay",
                            Scale = 0.3,
                            OffsetX = -800, -- should always be leftmost button
                            OffsetY = 0,
                        },
                        ...
                        TalentContainer =
                        {
                            ...
                            Children =
                            {
                                ...
                                StatLineLeft2 =
                                {
                                    ...
                                    AlphaTargetDuration = 0.3,
                                    GroupName = "Combat_Menu_TraitTray",
                                    TextArgs = MergeTables(ScreenData.UpgradeChoice.StatLineLeft,
                                        { OffsetY = ScreenData.UpgradeChoice.LineHeight })
                                },
                                StatLineRight2 =
                                {
                                    Alpha = 1.0,
                                    ...
                                    AlphaTargetDuration = 0.3,
                                    GroupName = "Combat_Menu_TraitTray",
                                    TextArgs = MergeTables(ScreenData.UpgradeChoice.StatLineRight,
                                        { OffsetY = ScreenData.UpgradeChoice.LineHeight })
                                },
                                TalentIcon =
                                {
                ...
                ActionBar =
                {
                    ...
                    Children =
                    {
                        SelectButton =
                        {
                            ...
                            UIData.ContextualButtonSpacing,
                            Y = UIData.ContextualButtonY,
                            Alpha = 0.0,
                            Data =
                            {
